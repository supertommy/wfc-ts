...
Candidate order: H37 dirty-cell bitset propagation, H38 cell-batched AC-4, H39 generated/specialized kernels, H40 propagation ordering. H37/H38/H41/H42 failed promotion; H39/H40 produced prototype-only signals. Next required step is a fresh STALL→IDEATE pass for genuinely new CPU mechanisms, then stop if it yields no high-payoff path.
